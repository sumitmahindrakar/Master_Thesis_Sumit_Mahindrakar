...
class PlotConfig:
    checkpoint_path = "RESULTS_15_case/best.pt"
    norm_data_path  = "DATA_15_case/graph_dataset_norm.pt"
    raw_data_path   = "DATA_15_case/graph_dataset.pt"
    save_dir        = "PLOTS_15_case"
