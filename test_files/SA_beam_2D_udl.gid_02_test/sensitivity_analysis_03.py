...
if __name__ == "__main__":
    ...
    # VTK file paths
    PRIMARY_VTK = "test_files/SA_beam_2D_udl.gid_02_test/vtk_output/Parts_Beam_Beams_0_1.vtk"
    DUAL_VTK = "test_files/SA_beam_2D_udl.gid_02_test/vtk_output_dual/Parts_Beam_Beams_0_1.vtk"
