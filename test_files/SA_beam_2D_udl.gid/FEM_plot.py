...
def create_frame_plots(vtk_data, save_figures=SAVE_FIGURES, 
    ...
    add_supports_r(ax1, points, support_indices=[2])
    ax1.set_xlabel('X (m)')
    ax1.set_ylabel('Y (m)')
    ...
    add_supports_r(ax2, points, support_indices=[2])
    ax2.set_xlabel('X (m)')
    ax2.set_ylabel('Y (m)')
    ...
    add_supports_r(ax3, points, support_indices=[2])
    ax3.set_xlabel('X (m)')
    ax3.set_ylabel('Y (m)')
    ...
    # print(points)
    add_supports_r(ax, points, support_indices=[2])
    ax.set_xlabel('X (m)')
    ax.set_ylabel('Y (m)')
