...
def main():
    ...
    # =========================================
    use_vtk_files = False  # Set to True if you want to read from VTK
    
    if use_vtk_files:
        # Update these paths to your VTK file locations
        primary_vtk = "vtk_output_primary/Structure_Parts_Beam_Beams_0_1.vtk"
        dual_vtk = "vtk_output_dual_elem2/Structure_Parts_Beam_Beams_0_1.vtk"
