...
def plot_results_with_analytical(vtk_data: VTKData, errors: Dict, 
    ...
    def plot_diagram(ax, x_fine, anal_fine_data, fem_data, errors_data, 
        ...
        if errors_data is not None:
            ...
            # Shade area under the FEM curve
            ax.fill_between(x_sorted, fem_data, 0, 
                color=colors['fem'], alpha=0.3)
...
def main():
    ...
    # =============== CONFIGURATION ===============
    VTK_FILE = "test_files/beam_2D_test_udl_refined.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"
    OUTPUT_PREFIX = "test_files/beam_2D_test_udl_refined.gid/plots/beam_results"
