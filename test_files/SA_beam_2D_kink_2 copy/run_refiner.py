...
INPUT_FILE = "test_files/SA_beam_2D_kink_2/SA_beam_2D_udl.mdpa"      # Input file name
OUTPUT_FILE = "test_files/SA_beam_2D_kink_2/SA_beam_2D_udl_refined.mdpa"  # Output file name
# INPUT_FILE = "test_files/SA_beam_2D_kink_2/SA_beam_2D_udl_dual.mdpa"      # Input file name
# OUTPUT_FILE = "test_files/SA_beam_2D_kink_2/SA_beam_2D_udl_dual_refined.mdpa" 
