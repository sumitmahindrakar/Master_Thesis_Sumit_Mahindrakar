...
def main():
    ...
    # =============== CONFIGURATION ===============
    VTK_FILE = "test_files/frame_2D_test_udl_refined.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"  # Your VTK file path
    OUTPUT_PREFIX = "test_files/frame_2D_test_udl_refined.gid/plots/frame_analysis"
