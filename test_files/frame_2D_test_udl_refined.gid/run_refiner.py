...
INPUT_FILE = "test_files/frame_2D_test_udl.gid/frame_2D_test_udl.mdpa"      # Input file name
OUTPUT_FILE = "test_files/frame_2D_test_udl_refined.gid/frame_2D_test_udl_refined.mdpa"  # Output file name
