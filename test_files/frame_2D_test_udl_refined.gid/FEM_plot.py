...
VTK_FILE_PATH = "test_files/frame_2D_test_udl_refined.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"  # <-- Change this to your VTK file path
...
OUTPUT_FOLDER = "test_files/frame_2D_test_udl_refined.gid/plots"     # Folder to save output figures
