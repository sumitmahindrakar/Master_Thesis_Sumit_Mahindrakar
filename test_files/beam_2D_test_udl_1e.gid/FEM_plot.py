...
VTK_FILE_PATH = "test_files/beam_2D_test_udl_1e.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"  # <-- Change this to your VTK file path
...
OUTPUT_FOLDER = "test_files/beam_2D_test_udl_1e.gid/plots"     # Folder to save output figures
...
def create_frame_plots(vtk_data, save_figures=SAVE_FIGURES, 
    ...
    add_roller_supports(ax1, points, support_indices=[1])
    ax1.set_xlabel('X (m)')
    ax1.set_ylabel('Y (m)')
    ...
    add_roller_supports(ax2, points, support_indices=[1])
    ax2.set_xlabel('X (m)')
    ax2.set_ylabel('Y (m)')
    ax2.set_xlim(-0.5, 2.5)#-1, 3.5
    ax2.set_ylim(-0.5, 0.5)#0.0, 3.2
    ...
    add_roller_supports(ax3, points, support_indices=[1])
    ax3.set_xlabel('X (m)')
    ax3.set_ylabel('Y (m)')
    ax3.set_xlim(-0.5, 2.5)#-1, 3.5
    ax3.set_ylim(-0.5, 0.5)#0.0, 3.2
    ...
    # print(points)
    add_roller_supports(ax, points, support_indices=[1])
    ax.set_xlabel('X (m)')
    ax.set_ylabel('Y (m)')
