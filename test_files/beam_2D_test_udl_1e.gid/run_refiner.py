...
INPUT_FILE = "test_files/beam_2D_test_udl_1e.gid/beam_2D_test_udl_1e.mdpa"      # Input file name
OUTPUT_FILE = "test_files/beam_2D_test_udl_1e.gid/beam_2D_test_udl_refined.mdpa"  # Output file name
