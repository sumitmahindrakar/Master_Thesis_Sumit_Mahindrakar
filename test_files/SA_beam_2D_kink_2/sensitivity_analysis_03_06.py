...
FIGURE_DPI = 100
SAVE_FIGURES = True
OUTPUT_FOLDER = "test_files/SA_beam_2D_kink_2/plots"
...
if __name__ == "__main__":
    ...
    PRIMARY_VTK = "test_files/SA_beam_2D_kink_2/vtk_output/Structure_0_1.vtk"
    DUAL_VTK = "test_files/SA_beam_2D_kink_2/vtk_output_dual/Structure_0_1.vtk"
    
    # Material JSON path (optional - will auto-search if None)
    MATERIAL_JSON = "test_files/SA_beam_2D_kink_2/StructuralMaterials.json"
