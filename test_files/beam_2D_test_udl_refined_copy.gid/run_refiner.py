...
INPUT_FILE = "test_files/beam_2D_test_udl.gid/beam_2D_test_udl.mdpa"      # Input file name
OUTPUT_FILE = "test_files/beam_2D_test_udl_refined.gid/beam_2D_test_udl_refined.mdpa"  # Output file name
