...
VTK_FILE_PATH = os.path.join(FOLDER, "vtk_output_dual/Parts_Beam_Beams_0_1.vtk")  # <-- Change this to your VTK file path
...
OUTPUT_FOLDER = os.path.join(FOLDER, "plots_dual")     # Folder to save output figures
