...
# INPUT_FILE = os.path.join(FOLDER, "frame_2D_test_udl_2_floor.mdpa")
# OUTPUT_FILE = os.path.join(FOLDER, "frame_2D_test_udl_2_floor_refined.mdpa")
INPUT_FILE = os.path.join(FOLDER, "frame_2D_test_udl_2_floor_dual.mdpa")
OUTPUT_FILE = os.path.join(FOLDER, "frame_2D_test_udl_2_floor_dual_refined.mdpa")
SUBDIVISIONS = 5                 # Number of subdivisions per element
