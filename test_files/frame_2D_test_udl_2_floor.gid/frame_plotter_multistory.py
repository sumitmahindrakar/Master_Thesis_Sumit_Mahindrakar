...
def main():
    ...
    # =============== CONFIGURATION ===============
    VTK_FILE = "test_files/frame_2D_test_udl_2_floor.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"
    OUTPUT_PREFIX = "test_files/frame_2D_test_udl_2_floor.gid/plots/frame_2story"
