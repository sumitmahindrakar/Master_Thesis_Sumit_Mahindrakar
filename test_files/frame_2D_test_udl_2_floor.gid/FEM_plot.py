...
VTK_FILE_PATH = "test_files/frame_2D_test_udl_2_floor.gid/vtk_output/Parts_Beam_Beams_0_1.vtk"  # <-- Change this to your VTK file path
...
OUTPUT_FOLDER = "test_files/frame_2D_test_udl_2_floor.gid/plots"     # Folder to save output figures
...
def create_frame_plots(vtk_data, save_figures=SAVE_FIGURES, 
    ...
    ax.text(0.20, 0.2, f'Max displacement: {max_disp:.6f} m\nScale factor: {DEFLECTION_SCALE}x',
